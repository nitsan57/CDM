...
class AdversarialTFPyEnvironment(tf_py_environment.TFPyEnvironment):
    ...
    The time_step_spec and other specs re adversalate to the agent's observations, and
    there are additional specs for therial policy that alters the
    environment.
    ...
    def step_adversary(self, actions):
        ...
        with tf.name_scope('step_adversary'):
            ...
            # print("-------------")
            # print("ADV VECTOR reward", reward.numpy())
            # print("ADV VECTOR step_type", step_type.numpy())
            # print("ADV VECTOR discount", discount.numpy())
